...
| **Ad-hoc — 2026-07-23 kullanıcı geri bildirimi** (IT-XX planına dahil değil, bkz. CLAUDE.md "Mevcut Durum") | Layout z-index/mobileOpen düzeltmesi · FilterPanel operatör küçültme + lookup değer alanı · gelişmiş arama 6 sayfaya yayılım · AI Eğit crash · Görev Yönetimi dashboard+task-type · Lookup/Form/Destek konsolidasyonu · idari alan+org toplu silme · sol menü daralt/genişlet + bildirim detay sayfası · sayfa kicker'larındaki iç kod adlarının temizlenmesi (IT-40 convention'ıyla örtüşüyor, resmen IT-40 olarak işlenmedi) · kullanıcı renk teması | ✅ (canlı doğrulama kullanıcıdan bekleniyor — Chrome uzantısı bu oturumda bağlanamadı) |
